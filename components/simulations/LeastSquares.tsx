...
export default function LeastSquares() {
    ...
    return (
        <div className="flex flex-col gap-6 p-6 items-center w-full max-w-5xl mx-auto">
            <div className="text-center">
                <h1 className="text-3xl font-bold tracking-tight">Ordinary Least Squares</h1>
                <p className="text-muted-foreground mt-2">Interactive Linear Regression Demo</p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
                <Card>
                    <CardContent className="pt-6 text-center">
                        <div className="text-2xl font-bold font-mono">{stats.m.toFixed(3)}</div>
                        <div className="text-sm text-muted-foreground">Slope (m)</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardContent className="pt-6 text-center">
                        <div className="text-2xl font-bold font-mono">{stats.b.toFixed(2)}</div>
                        <div className="text-sm text-muted-foreground">Intercept (b)</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardContent className="pt-6 text-center">
                        <div className="text-2xl font-bold font-mono">{stats.r.toFixed(3)}</div>
            ...
            <p className="text-sm text-muted-foreground">Click anywhere on the grid to add data points manually.</p>

            <div className="flex gap-4">
                <Button variant="secondary" onClick={handleReset}>Reset Canvas</Button>
